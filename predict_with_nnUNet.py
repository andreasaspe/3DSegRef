...
def predict_with_nn_unet_on_filelist():
    ...
    model_folder = "/scratch/awias/data/Pancreas/nnUNet_dataset/nnUNet_results/Dataset001_Pancreas/nnUNetTrainerNoMirroring__nnUNetResEncUNetLPlans__3d_fullres"

    input_data_folder = "/scratch/awias/data/Pancreas/nnUNet_dataset/nnUNet_raw/Dataset001_Pancreas/imagesTs"
    output_folder = "/scratch/awias/data/Pancreas/nnUNet_dataset/nnUNet_raw/Dataset001_Pancreas/imagesTs/man_preds"

    os.environ["nnUNet_results"] = "/scratch/awias/data/Pancreas/nnUNet_dataset/nnUNet_results"
