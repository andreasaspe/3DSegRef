...
root = "/scratch/awias/data/nnUNet/nnUNet_raw/Dataset003_TotalSegmentatorLiver"
...
dataset = {
    "name": "Dataset003_TotalSegmentatorLiver",  # change name
    "description": "Dataset for liver segmentation from TotalSegmentator dataset", #change description
    "reference": "",
    "licence": "",
    "release": "1.0",
    "tensorImageSize": "3D",
