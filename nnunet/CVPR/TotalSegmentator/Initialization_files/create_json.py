...
root = "/scratch/awias/data/nnUNet/nnUNet_raw/Dataset013_TotalSegmentator_4organs"
...
dataset = {
    "name": "Dataset013_TotalSegmentator_4organs",  # change name
    "description": "Dataset for 4 totalsegmentator organs", #change description
    "reference": "",
    "licence": "",
    "release": "1.0",
    "tensorImageSize": "3D",
